...
public class LibTokDemo {
	...
	public static void main (String[] args) {
		...
		System.out.println("Испогльзование токенайзера из библиотеки  Stanford");
		CoreLabeTokenFactory ctf = new CoreLabeTokenFactory();
		PBTTokenizer ptb = new PTBTokenizer(new StringReader(paragraph), ctf, "invertible=true");
		while (ptb.hasNext()) {
			CorelLabel cl = (CoreLabel) ptb.next();
		...
		DocumentPreprocessor documentPreprocessor = new DocumentPreprocessor(reade);
